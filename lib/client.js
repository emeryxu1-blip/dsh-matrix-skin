...
const MATRIX_SOURCE_LIMITS = Object.freeze({
  domCharacters: 1200,
  domTextNodes: 64,
  domVisitedNodes: 512,
...
function matrixSourcesFromDom(root, blank = false) {
...
function isMatrixTrailOutside(y, trail, fontSize, height) {
...
function bindSessionRoster(ctx, onSources) {
...
const bindSessionFeed = bindSessionRoster;
